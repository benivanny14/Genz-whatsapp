...
const {
  ...
  exportModSettings,
  importModSettings,
  setContactPrivacyOverride,
  getContactPrivacyOverrides,
  clearContactPrivacyOverride
...
router.get('/contact-privacy', getContactPrivacyOverrides);
router.put('/contact-privacy/:contactId', setContactPrivacyOverride);
router.delete('/contact-privacy/:contactId', clearContactPrivacyOverride);
