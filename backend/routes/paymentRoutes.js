...
// Admin routes with admin validation
router.post('/admin/activate', protect, isAdmin, adminActivatePremium);
router.post('/admin/deactivate', protect, isAdmin, adminDeactivatePremium);
router.get('/admin/all-payments', protect, isAdmin, getAllPayments);
router.get('/admin/statistics', protect, isAdmin, getPaymentStatistics);
router.get('/admin/user/:userId', protect, isAdmin, getUserPaymentDetails);
