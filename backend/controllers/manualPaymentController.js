...
const RECEIVER_NAME = process.env.MANUAL_PAYMENT_RECEIVER_NAME || 'ERASTOR GODFREY PAUL';
const RECEIVER_NUMBER = process.env.MANUAL_PAYMENT_RECEIVER_NUMBER || '0639533428';
...
exports.getPaymentInfo = async (req, res) => {
  res.json({
    ...
    instructions: [
      `Send payment to ${RECEIVER_NUMBER} (${RECEIVER_NAME}).`,
