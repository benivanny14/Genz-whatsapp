...
const userSchema = new mongoose.Schema({
  ...
  // TM "Custom Tick & Last Seen for Specific Contact" — per-contact privacy overrides.
  // Keyed by the other user's ObjectId (as a string), e.g.
  // { "<contactId>": { showLastSeen: true, showReadReceipts: false } }
  contactPrivacyOverrides: {
    type: mongoose.Schema.Types.Mixed,
    default: {}
  },
