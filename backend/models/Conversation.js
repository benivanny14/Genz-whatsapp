...
const conversationSchema = new mongoose.Schema({
  ...
  // Per-chat translation language override (TM "Language Per Chat"). Empty = use device default.
  language: {
    type: String,
    default: ''
  },
  // Group Voice Chat — Clubhouse-style ambient audio room for large groups
  voiceChat: {
