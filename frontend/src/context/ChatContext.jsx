...
export const ChatProvider = ({ children }) => {
  ...
  const setMods = useCallback((updater) => {
    setModsState(prev => {
      ...
      Promise.resolve().then(async () => {
        ...
        try {
          await authFetch(`${SOCKET_URL}/api/genz-mods/settings`, {
            method: 'PUT',
  ...
  const scheduleMessage = async (content, conversationId, sendAt, options = {}) => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/scheduled-messages`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          conversationId,
  ...
  const cancelScheduledMessage = async (scheduledMessageId) => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/scheduled-messages/${scheduledMessageId}`, {
        method: 'DELETE'
      });
      const data = await response.json();
      if (data.success) {
  ...
  const getScheduledMessages = async (conversationId = null) => {
    try {
      const url = conversationId
        ? `${SOCKET_URL}/api/scheduled-messages?conversationId=${conversationId}`
        : `${SOCKET_URL}/api/scheduled-messages`;
  ...
  const uploadStatusMedia = async (file) => {
    ...
    try {
      const response = await authFetch(`${SOCKET_URL}/api/advanced/status/upload`, {
        method: 'POST',
        body: formData
      });
      const data = await response.json();
  ...
  const generate2FASecret = async () => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/security/2fa/generate`, {
        method: 'POST'
      });
      const data = await response.json();
  ...
  const verify2FASetup = async (secret, token) => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/security/2fa/verify`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const disable2FA = async () => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/security/2fa/disable`, {
        method: 'POST'
      });
      const data = await response.json();
      return data;
  ...
  const sendEmailVerification = async (email) => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/security/email/send-verification`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const verifyEmail = async (token) => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/security/email/verify`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const resendEmailVerification = async (email) => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/security/email/resend-verification`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ email })
      });
  ...
  const sendPasswordReset = async (email) => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/security/password/send-reset`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ email })
      });
  ...
  const resetPassword = async (token, newPassword) => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/security/password/reset`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const fetchGENZModsSettings = async () => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/genz-mods/settings`);
      const data = await response.json();
      if (data.success) {
  ...
  const fetchDeletedMessages = async () => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/genz-mods/deleted-messages`);
      const data = await response.json();
      return data;
    } catch (err) {
  ...
  const restoreDeletedMessage = async (messageId) => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/genz-mods/restore-message/${messageId}`, {
        method: 'POST'
      });
      const data = await response.json();
      return data;
  ...
  const processAutoReply = async (userId, message) => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/genz-mods/auto-reply`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const getUserStatusWithGhostMode = async (userId) => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/genz-mods/user-status/${userId}`);
      const data = await response.json();
      return data;
    } catch (err) {
  ...
  const fetchBroadcasts = async () => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/advanced/broadcast`);
      const data = await response.json();
      if (data.success) {
  ...
  const updateBroadcast = async (broadcastId, updateData) => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/advanced/broadcast/${broadcastId}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  const sendBroadcastMessage = async (broadcastId, message) => {
    try {
      const response = await authFetch(`${SOCKET_URL}/api/advanced/broadcast/${broadcastId}/send`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const deleteStatus = useCallback(async (statusId) => {
    try {
      ...
      const response = await authFetch(`${SOCKET_URL}/api/advanced/status/${sid}`, {
        method: 'DELETE'
      });
      const data = await response.json();
      if (data.success) {
  ...
  const replyToStatus = useCallback(async (statusId, replyData, statusOwner = null) => {
    try {
      ...
      try {
        const sid = encodeURIComponent(statusId);
        const response = await authFetch(`${SOCKET_URL}/api/advanced/status/${sid}/reply`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
  ...
  const updateGroupMember = async (groupId, memberId, updates) => {
    try {
      const token = localStorage.getItem('token');
      const response = await authFetch(`${SOCKET_URL}/api/groups/${groupId}/members/${memberId}`, {
        method: 'PUT',
        headers: {
  ...
  const joinGroup = async (groupId, inviteCode) => {
    try {
      const token = localStorage.getItem('token');
      const response = await authFetch(`${SOCKET_URL}/api/chat/groups/${groupId}/join`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const transcribeAudio = async (audioBlob) => {
    try {
      ...
      const res = await authFetch(`${SOCKET_URL}/api/advanced/transcribe-audio`, { method: 'POST', body: formData });
  ...
  const viewProfile = async (userId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await authFetch(`${SOCKET_URL}/api/users/${userId}/profile`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const addContact = async (contactData) => {
    try {
      const token = localStorage.getItem('token');
      const response = await authFetch(`${SOCKET_URL}/api/contacts`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const removeContact = async (contactId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await authFetch(`${SOCKET_URL}/api/contacts/${contactId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const searchMessages = async (conversationId, query) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`${SOCKET_URL}/api/chat/conversations/${conversationId}/search?query=${encodeURIComponent(query)}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const getMessageInfo = async (messageId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`${SOCKET_URL}/api/chat/messages/${messageId}/info`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const markViewOnceViewed = async (messageId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`${SOCKET_URL}/api/chat/messages/${messageId}/view-once-viewed`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const forwardMessage = async (messageIdOrContent, targetConversationIdsOrSenderName) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`${SOCKET_URL}/api/chat/messages/${messageIdOrContent}/forward`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const reportMessage = async (messageId, reason, details = '') => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`${SOCKET_URL}/api/chat/messages/${messageId}/report`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const getGroupInfo = async (groupId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`${SOCKET_URL}/api/chat/groups/${groupId}/info`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const regenerateGroupInvite = async (groupId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`${SOCKET_URL}/api/chat/groups/${groupId}/invite/regenerate`, {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const removeAdmin = async (groupId, userId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`${SOCKET_URL}/api/chat/groups/${groupId}/admins/${userId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
