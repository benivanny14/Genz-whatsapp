...
const DEFAULT_GENZ_SETTINGS = {
  mods: {
    ...
    deleteMessages3Days: false,
    sendImages100Plus: false,
    sendVideo1GB: false,
    sendDocument1GB: false,
    broadcast600Plus: false,
    pinMoreThan3Chats: false,
    stylishText: false,
    blankMessages: false,
    increaseForwardLimit: false,
    // Additional Media & Messaging features
    autoDownloadVideos: false,
    autoDownloadAudio: false,
    autoDownloadDocuments: false,
    imageQuality: 'standard',
    videoQuality: 'standard',
    mediaCompressor: false,
    gifPlayer: true,
    stickerMaker: false,
    imageEditor: false,
    videoEditor: false,
    ...
    themes4000Plus: false,
    customFonts: false,
    chatBubbleStyles: false,
    tickStyles: false,
    launcherIconChange: false,
    notificationIconChange: false,
    amoledMode: false,
    customNotificationSounds: false,
    popupNotifications: false,
    fabCustomization: false,
    homeScreenStyles: false,
    conversationEntryStyle: false,
    emojiChanger: false,
    ...
    multiAccounts: false,
    cloneApp: false,
    airplaneModeAppOnly: false,
    dndMode: false,
    increaseStatusCharacters: false,
    increaseGroupMembers: false,
    increaseStatusVideoLength: false,
    fakeChat: false,
    fakeVoiceVideoCall: false,
    contactOnlineNotifier: false,
    directMessage: false,
    whatsappWeb: false,
    separateGroupChats: false,
    separateBroadcastChats: false,
    showDeletedMessages: false,
    showDeletedStatus: false,
    copyStatusCaption: false,
    zoomProfilePicture: false,
    toastWhenOnline: false,
    toastWhenTyping: false,
    solidColorBackground: false,
    defaultMessage: false,
    quickReply: false,
    swipeToReply: false,
    swipeToArchive: false,
    archiveAllChats: false,
    clearAllChats: false,
    ...
    ipMask: false,
    secureMode: false,
    // Additional Chat Space features
    ...
    messageCopyWithSelection: false,
    messageSearchWithinChat: false,
    jumpToFirstMessage: false,
    jumpToSpecificDate: false,
    quickCamera: false,
    quickVoiceMessage: false,
    quickEmojiReaction: false,
    autoReplyInChat: false,
    antiRevokeInChat: false,
    hideTypingInChat: false,
    customBubblePerContact: false,
    chatLock: false,
    secretChat: false,
    selfDestructingMessages: false,
    messageRecall: false,
    // Additional Chat List & Main Dashboard features
    chatListAvatar: true,
    chatListName: true,
    chatListLastMessage: true,
    chatListTimestamp: true,
    chatListUnreadCount: true,
    chatListMuteIndicator: true,
    chatListPinIndicator: false,
    chatListArchiveIndicator: true,
    chatListOnlineStatus: true,
    chatListTypingIndicator: true,
    chatListSwipeActions: true,
    chatListLongPress: true,
    chatListDoubleTap: false,
    chatListSearch: true,
    chatListFilter: false,
    chatListSort: 'recent',
    chatListViewMode: 'list',
    chatListDensity: 'comfortable',
    chatListGroupBy: 'none',
    dashboardQuickActions: true,
    dashboardStats: false,
    dashboardRecentChats: true,
    dashboardPinnedChats: false,
    dashboardArchivedChats: false,
    dashboardStarredMessages: false,
    groupsTab: false,
    broadcastTab: false,
    tabIndicator: false,
    tabSwipe: false,
    unreadBadgeOnTabs: false,
    groupMemberCount: false,
    adminBadge: false,
    addParticipants: false,
    removeParticipants: false,
    makeAdmin: false,
    dismissAsAdmin: false,
    groupSettings: false,
    groupMedia: false,
    ...
    statusCameraCapture: false,
    statusGallerySelection: false,
    statusMultiSelect: false,
    statusTextStatus: false,
    statusLinkStatus: false,
    statusGIFStatus: false,
    statusVoiceStatus: false,
    statusMusicStatus: false,
    statusPollStatus: false,
    statusQuizStatus: false,
    statusQuestionStatus: false,
    statusCountdownStatus: false,
    statusLocationStatus: false,
    statusCollageStatus: false,
    statusBoomerangStatus: false,
    statusReactionStatus: false,
    statusFullScreenViewer: false,
    statusTapToNextPrevious: false,
    statusSwipeToDismiss: false,
    statusHoldToPause: false,
    statusViewerList: false,
    statusScreenshotDetection: false,
    statusPasswordProtection: false,
    statusFingerprintProtection: false,
    statusScheduling: false,
    statusHighlights: false,
