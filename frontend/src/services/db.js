// Native IndexedDB Wrapper for Genz Messenger
...
const getDBName = () => {
  try {
    ...
    console.warn('[DB] Failed to get user for DB name:', e);
  }
  return DB_BASE_NAME;
};
  ...
  deleteDatabase: async () => {
    try {
      ...
      await new Promise((resolve, reject) => {
        ...
        request.onblocked = () => {
          console.warn('[DB] Database delete blocked, closing connections...');
          resolve();
        };
      });
