...
const BroadcastCard = ({ broadcast, onBroadcastUpdate, onBroadcastDelete, onSendMessage }) => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const result = await broadcastService.sendBroadcastMessage(broadcast.id, messageData);
      toast.success(result?.message || 'Broadcast message sent');
      setMessage('');
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className={`flex items-center space-x-1 transition-opacity ${
            ...
            <button
              ...
              className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
              title="Edit Broadcast" aria-label="Edit Broadcast"
            >
            ...
            <button
              ...
              title="Delete Broadcast" aria-label="Delete Broadcast"
            >
