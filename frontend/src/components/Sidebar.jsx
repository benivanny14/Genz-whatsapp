...
<body>
  ...
  return (
    <aside
      className={`relative overflow-hidden bg-dark-surface glass-panel border-r border-dark-border flex flex-col transition-all duration-300 ${isOpen ? 'w-full md:w-80' : 'w-0 md:w-16 overflow-hidden'}`}
    >
