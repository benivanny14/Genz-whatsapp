  ...
  return (
    ...
    >
      ...
      <div className="absolute right-4 bottom-32 z-50 flex flex-col items-center gap-5" onClick={(e) => e.stopPropagation()}>
        ...
        {/* Share */}
        <button onClick={handleShare} className="p-3 rounded-full bg-black/40 backdrop-blur-sm">
          ...
          >
            ...
            <div className="flex gap-2">
              <input
                ...
                autoFocus
              />
              <button onClick={handleComment} className="px-4 py-3 bg-green-600 rounded-xl text-white font-bold">
                <Send size={18} />
              </button>
            </div>
