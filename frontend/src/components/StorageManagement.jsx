      ...
      <div className="w-full max-w-5xl max-h-[88vh] bg-[#0d1f35] border border-white/10 rounded-2xl shadow-2xl overflow-hidden flex flex-col">
        <div className="p-4 border-b border-white/10 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button type="button" onClick={loadStorage} className="p-2 rounded-lg bg-white/10 hover:bg-white/15 text-white" title="Refresh storage">
              <RefreshCw size={16} className={loading ? 'animate-spin' : ''} />
            </button>
            <button type="button" onClick={onClose} className="p-2 rounded-lg bg-white/10 hover:bg-white/15 text-white" title="Close">
              <X size={16} />
            </button>
          </div>
        </div>
            ...
            {summary.map((chat) => (
              <div key={chat.conversationId} className="flex gap-2">
                ...
                <button
                  ...
                  title="Clear media from this chat cache"
                >
                  <Trash2 size={16} />
                </button>
              </div>
                  ...
                  return (
                    <div key={item._id} className="bg-white/5 border border-white/10 rounded-xl p-3 flex items-center gap-3">
                      ...
                      <button
                        ...
                        title="Delete this cached media item"
                      >
                        <Trash2 size={16} />
                      </button>
                    </div>
