...
import {
  ...
  Activity, BarChart, Upload, DollarSign, ChevronRight, Bug, Store, Trash2, MicOff, Wifi
} from 'lucide-react';
    ...
    const timer = setTimeout(() => {
      try {
        ...
        if (e.name === 'QuotaExceededError') {
          toast.error('Profile picture is too large. Please choose a smaller image.');
        }
      }
    ...
    <>
      ...
      {mods.fakeChatCover && (
        ...
        >
          ...
          <div>
            <h3 className="text-sm font-semibold text-yellow-400">Open Fake Chat</h3>
            <p className="text-xs text-white/50">Select from ready-made conversations</p>
          </div>
