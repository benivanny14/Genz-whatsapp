          ...
          <div className="max-h-96 overflow-y-auto space-y-2">
            {(filteredContacts || []).map(contact => (
              <div key={contact._id} className="flex items-center justify-between p-3 bg-dark-bg rounded-lg">
                ...
                <div className="flex gap-2">
                  <button className="p-2 hover:bg-dark-hover rounded-lg text-primary-500" aria-label="Call">
                    <Phone size={16} />
                  </button>
                  <button className="p-2 hover:bg-dark-hover rounded-lg text-primary-500" aria-label="Message">
                    <MessageSquare size={16} />
                  </button>
                  <button className="p-2 hover:bg-dark-hover rounded-lg text-dark-textSecondary" aria-label="Edit">
                    <Edit size={16} />
                  </button>
                  <button
