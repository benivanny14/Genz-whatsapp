    ...
    <div className="fixed inset-0 z-[500] flex items-center justify-center p-4" 
      ...
      <div className="w-full max-w-lg bg-[#0d1f35] rounded-2xl border border-white/15 shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between p-5 border-b border-white/10 bg-gradient-to-r from-blue-900/50 to-purple-900/50">
          ...
          <button onClick={onClose} className="p-2 hover:bg-white/10 rounded-full transition-colors text-white" aria-label="Close">
            <X size={20} />
          </button>
        </div>
        ...
        <div className="p-5 space-y-5 max-h-[75vh] overflow-y-auto">
          ...
          <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/10">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xs">The whole UI becomes transparent glass</p>
              </div>
            </div>
            <button
          ...
          <div className="bg-white/5 rounded-xl border border-white/10 overflow-hidden">
            ...
            <div className="p-4 space-y-3">
              ...
              <div>
                <p className="text-gray-500 text-xs mb-1">Or paste a video URL:</p>
                <input
                  type="text"
          ...
          <div className="bg-white/5 rounded-xl border border-white/10 overflow-hidden">
            ...
            <div className="p-4 space-y-3">
              ...
              {/* URL input alternative */}
              <div>
                <p className="text-gray-500 text-xs mb-1">Or paste an image URL:</p>
                <input
                  type="text"
