        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#25d366] text-[#071b16] text-xs font-bold hover:opacity-90"
              title="Manual mobile money payment verification"
            >
              <CreditCard size={14} /> Manual Payments
            </button>
