...
const Broadcasts = () => {
  ...
  const handleCreateBroadcast = async () => {
    ...
    try {
      ...
      setNewBroadcast({ name: '', description: '', recipients: [], tags: [] });
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Team Members, Family, Clients"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Optional description for this broadcast list"
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                    rows={3}
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700">
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      You can add recipients after creating the broadcast list
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="e.g., work, family, important"
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                  />
                </div>
              </div>
              ...
              <div className="mt-6 flex justify-end space-x-3">
                ...
                <button
                  ...
                  disabled={creating || !newBroadcast.name.trim()}
