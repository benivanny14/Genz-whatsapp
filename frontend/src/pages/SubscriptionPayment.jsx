...
export default function SubscriptionPayment() {
  ...
  return (
    <div className="h-screen bg-[#0d1b2a] text-white flex flex-col overflow-hidden">
      <header className="sticky top-0 z-40 bg-[#075e54] px-4 py-3 border-b border-white/10 flex items-center gap-3 flex-shrink-0">
      ...
      <main className="px-4 pt-4 space-y-5 max-w-xl mx-auto pb-20 flex-1 overflow-y-auto">
