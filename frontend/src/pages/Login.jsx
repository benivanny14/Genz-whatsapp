...
import { Eye, EyeOff, Lock, LogIn, Phone, Smartphone, Download } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0b141a] flex items-center justify-center px-4">
      <form onSubmit={handleOTPOrLogin} className="w-full max-w-md bg-[#111b21] border border-white/10 rounded-lg p-6 shadow-2xl">
        ...
        <div className="mt-6 pt-4 border-t border-white/10 text-center">
          <a
            href="/genz-whatsapp.apk?v=1"
            download="genz-whatsapp.apk"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-sm font-medium text-[#00a884] hover:text-[#008f6f] transition-colors bg-[#00a884]/10 hover:bg-[#00a884]/20 px-4 py-2 rounded-full"
          >
            <Download size={16} />
            Pakua App ya Android (APK)
          </a>
        </div>
      </form>
    </div>
